    ...
    <div className="container">
      ...
      <div className='calculator'>
          ...
          <div className='digits'>
            ...
            <button className='buttons'onClick={() =>{ setDisplay("") }}> C</button>
            <button className='buttons'onClick={() =>{ setDisplay(display += " - ") }}> -</button>
            ...
            <button className='buttons'onClick={() =>{ setDisplay(display += " * ") }}> X</button>
            ...
            <button className='buttons' onClick={() =>{ setDisplay(display += " + ") }}> +</button>
            <button className='buttons' onClick={() =>{ setDisplay(display += ".") }}> .</button>
            <button className='buttons'onClick={() =>{ setDisplay(display += "0") }}> 0</button>
            <button className='buttons' onClick={() =>{ let resultado = (eval(display)) 
